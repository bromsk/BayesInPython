...
```{r compareCoef1nbBambi, echo = F}
# az.summary(idata_bmb1nb)[, 1:4]
kable(round(py$tmp1nb, 3), caption = "Coefficient estimates from the Bayesian framework, fit using the bambi module")
kable(py$nb1pyout, caption = "Coefficient estimates from the frequentist framework, fit using sm.NegativeBinomial().")
```
...
# az.summary(idata_bmb1nb)[, 1:4]
kable(round(py$tmp1nbPyMC, 3), caption = "Coefficient estimates from the Bayesian framework, fit using the PyMC module")
kable(py$nb1pyout, caption = "Coefficient estimates from the frequentist framework, fit using sm.NegativeBinomial().")
```
