...
(Alternatively, we could fit over-dispersed Poisson regressions or quasi-Poisson regressions. A zero-inflated model may also be appropriate and worth assessing.)
...
## GLMM: Random effects (RE) for locations
...
$j = 1, ..., J = 117$ represents the 117 unique sampling dates,
...
Note that the crossed random effect, sampling date, is not correlated with the intercept, slope random effects associated with location.
...
$j = 1, ..., J = 117$ represents the 117 unique dates,
...
$l_k$ = length-scale associated with location $k$,
