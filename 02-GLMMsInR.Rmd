...
```{r TrapsPlotted, fig.cap = "Trap coordinates for each location."}
coords <- datR %>%
...
```{r TR1nb, tab.cap = "Trapping reduction estimate for the negative binomial GLM model."}
...
```{r p1nb-glmFig, fig.cap = "Negative bimomial GLM predictions."}
## code to predict moth counts from model:
...
```{r pois2, tab.cap = "Trapping reduction estimate for the Poisson GLMM model."}
...
```{r p2nb-glmmFig, fig.cap = "NB GLMM moth count predictions."}
...
```{r pBayes2nb-Fig, results = "hide", fig.cap = "Bayesian negative binomial GLM predictions."}
## plot predictions:
...
```{r pois3, tab.cap = "Trapping reduction estimate for the Crossed Poisson GLMM model."}
...
```{r TRBayes3nb, tab.cap = "Trapping reduction estimate for the negative binomial GLMM model."}
# CALC TR:
...
```{r pBayes3nb-Fig, results = "hide", fig.cap = "Bayesian crossed NB GLMM predictions."}
# plot predictions:
...
```{r compareBetas, echo = F, tab.cap = "Comparison of regression coefficient estimates from each model fit."}
